...
export default function ProfilePage() {
    ...
    return (
      <div className="trading-dashboard min-h-screen flex flex-col">
        <div className="flex flex-1 overflow-hidden">
          ...
          <main className={`flex-1 overflow-auto transition-all duration-300 w-full p-8 ${forceMobileOnTablet ? '' : (sidebarCollapsed ? 'pl-20' : 'pl-68')}`}>
  ...
  return (
    <div className="trading-dashboard sm:mb-10 md:mb-10 min-h-screen flex flex-col">
      <div className="flex flex-1 overflow-hidden">
        <TradingSidebar collapsed={sidebarCollapsed} onCollapsedChange={setSidebarCollapsed} forceMobileNav={forceMobileOnTablet} />

        <main className={`flex-1 overflow-auto transition-all duration-300 w-full ${
          forceMobileOnTablet ? 'p-4 sm:p-8 pb-28 sm:pb-6' : `p-4 sm:p-8 pb-28 sm:pb-6 ${sidebarCollapsed ? 'sm:pl-20 pl-4' : 'sm:pl-68 pl-4'}`
        }`}>
          <div className="mb-6">
