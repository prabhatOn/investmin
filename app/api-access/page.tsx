...
export default function ApiAccessPage() {
  ...
  return (
    <div className="trading-dashboard min-h-screen sm:mb-10 md:mb-10 flex flex-col relative">
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className={`flex-1 flex flex-col gap-6 overflow-auto transition-all duration-300 w-full ${
          forceMobileOnTablet ? "pl-4 pr-4 pt-6 sm:pb-6 pb-28" : (sidebarCollapsed ? "sm:pl-20 pl-4 pr-4 sm:pr-6 pt-6 sm:pb-6 pb-28" : "sm:pl-68 pl-4 pr-4 sm:pr-6 pt-6 sm:pb-6 pb-28")
        }`}>
          {loading ? (
