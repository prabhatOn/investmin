  ...
  return (
    <div className="trading-dashboard sm:mb-10 md:mb-10 min-h-screen flex flex-col relative">
      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        ...
        <main className={`flex-1 flex flex-col gap-6 overflow-auto transition-all duration-300 w-full max-w-full mx-auto px-4 sm:px-6 lg:px-8 ${
          sidebarCollapsed ? "lg:ml-16 pt-6 pb-28 sm:pb-6 lg:max-w-[calc(100%-80px)]" : "lg:ml-64 pt-6 pb-28 sm:pb-6 lg:max-w-[calc(100%-272px)]"
        }`}>
          ...
          <Card className="trading-card-override w-full mx-auto">
            <CardContent className="pt-6">
              <div className="flex flex-col gap-4">
                {/* Preset buttons - responsive grid */}
                <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                  <Button size="sm" variant={preset === '1' ? 'default' : 'ghost'} onClick={() => applyPresetDays(1)} className="flex-1 sm:flex-none min-w-[60px]">1 day</Button>
                  <Button size="sm" variant={preset === '7' ? 'default' : 'ghost'} onClick={() => applyPresetDays(7)} className="flex-1 sm:flex-none min-w-[60px]">7 days</Button>
                  <Button size="sm" variant={preset === '15' ? 'default' : 'ghost'} onClick={() => applyPresetDays(15)} className="flex-1 sm:flex-none min-w-[60px]">15 days</Button>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 items-center justify-center sm:justify-start">
                  <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
                    ...
                    <span className="text-sm sm:hidden">to</span>
                    <input
                      type="date"
                      value={toDate ?? ''}
                  ...
                  <Button size="sm" onClick={applyCustomRange} className="w-full sm:w-auto">Apply</Button>
                </div>

                {/* Side filter - centered on mobile */}
          ...
          <Card className="flex-1 positions-container w-full mx-auto">
                ...
                <>
                  ...
                  <div className="flex flex-col gap-3 sm:hidden w-full">
                    {filteredPositions.map((position: Position) => {
                      ...
                      return (
                        <Card key={position.id} className="p-3 w-full">
