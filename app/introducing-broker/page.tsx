...
export default function IntroducingBrokerPageV2() {
  ...
  // viewport detection: used to force mobile bottom nav on mid-size (tablet) viewports
  ...
  if (!ibStatus?.isIB) {
  const applicationStatus = (ibStatus?.applicationStatus ?? 'not_applied') as keyof typeof statusCopy;
    const statusCopy = {
      not_applied: {
        label: 'Not applied',
    ...
    return (
      <div className="trading-dashboard sm:mb-10 md:mb-10 min-h-screen flex">
        ...
        <div className={`flex flex-1 items-center justify-center transition-all duration-300 ${
          forceMobileOnTablet ? "pl-4 pr-4 sm:pr-6" : (sidebarCollapsed ? "sm:pl-20 pl-4 pr-4 sm:pr-6" : "sm:pl-68 pl-4 pr-4 sm:pr-6")
  ...
  return (
    <div className="trading-dashboard min-h-screen flex">
      ...
      <div className={`flex-1 min-w-0 transition-all duration-300 ${
        forceMobileOnTablet ? "pl-1 pr-1" : (sidebarCollapsed ? "sm:pl-20 pl-4 pr-4 sm:pr-6" : "sm:pl-68 pl-4 pr-4 sm:pr-6")
      }`}>
        <main className="mx-auto w-full max-w-[1400px] min-w-0 space-y-8 px-4 py-10 sm:px-6 lg:px-12 pb-28 sm:pb-6">
                  ...
                  <div className="space-y-6">
                        ...
                        <>
                          ...
                          <div className="overflow-x-auto px-2 pb-6">
                            <div className="rounded-2xl border border-border/60 bg-background/95 shadow-sm">
                              <table className="w-full min-w-[600px] sm:min-w-[760px] text-sm">
                    ...
                    <section className="rounded-2xl border border-border/60 bg-gradient-to-br from-background via-background/95 to-background/80 shadow-xl">
                      ...
                      <div className="overflow-x-auto px-2 pt-2">
                        <div className="rounded-2xl border border-border/60 bg-background/95 shadow-sm">
                          <table className="w-full min-w-[600px] sm:min-w-[680px] text-sm">
                            <thead className="bg-muted/40 text-xs uppercase tracking-wide text-muted-foreground">
                              <tr>
                                <th className="px-5 py-3 text-left">Opened</th>
                                <th className="px-5 py-3 text-left">Symbol</th>
